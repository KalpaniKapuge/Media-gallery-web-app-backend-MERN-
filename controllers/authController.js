...
export const login = async (req, res) => {
  try {
    ...
    // Ensure email is a string and trim/lowercase it
    ...
    // Find user by email
    console.log('Searching for user with email:', emailStr);
    ...
    // Check if user has a password (for Google users who might not have one)
